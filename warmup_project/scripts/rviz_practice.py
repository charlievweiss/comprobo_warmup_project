...
# make sure to import all the necessary things for the object (Marker)
import rospy
...
class PublishSphereNode(object):
    def __init__(self):
        ...
        # Set allllll the gosh darn parameters for Marker
        # Pose:
        ...
        text = None
        mesh_resource = None
        # make self for reference in "run" function
